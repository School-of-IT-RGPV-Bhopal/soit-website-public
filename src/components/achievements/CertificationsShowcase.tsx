...
import { Certification, certifications } from "@/data/student_achievements/certifications";
        ...
        <div className="relative flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            <span
              ...
              aria-hidden="true"
            >
              <span className={cn("text-slate-800", cert.accent)}>
                {cert.icon}
              </span>
            </span>
          ...
          <ul className="mt-3 space-y-2">
            {cert.certifications.map((name, idx) => (
              <li key={idx} className="flex gap-2 text-sm text-slate-700">
                <span
                  className={cn("mt-1.75 size-1.5 rounded-full", cert.accent)}
                />
    ...
    <section className="relative overflow-hidden bg-slate-50 py-16">
      ...
      >
        <header className="mx-auto mb-12 max-w-2xl text-center">
          ...
          "
          >
            Students equipped with globally recognized, job-aligned credentials
          ...
          >
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-3 text-slate-600">
                Structured resources and guidance designed to help students
                prepare effectively and certify with confidence.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                <p className="mt-3 text-sm/relaxed text-slate-600">
                  Curated guides, labs, and practice assessments aligned with
              ...
              >
                ...
                <p className="mt-3 text-sm/relaxed text-slate-600">
                  Regular guidance and checkpoints from experienced mentors to
              ...
              >
                ...
                <p className="mt-3 text-sm/relaxed text-slate-600">
                  Collaborative sessions to reinforce concepts, solve questions,
                  and share exam strategies.
                </p>
              </div>
            </div>
          </div>
